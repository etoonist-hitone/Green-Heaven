        ...
        <div>
          <div className="flex flex-col xs:flex-row xs:items-center justify-between pt-2 sm:pt-4 border-t border-stone-100 gap-2">
            ...
            <div className="flex gap-1 w-full xs:w-auto">
              ...
              <a
                href={product.stock_status === "sold_out" ? undefined : getProductWhatsAppLink(product)}
                target="_blank"
                rel="noopener noreferrer"
                className={`flex-1 xs:flex-none px-2 sm:px-4 py-1.5 sm:py-2 text-[10px] sm:text-xs font-bold rounded-lg sm:rounded-xl transition-all duration-200 text-center flex items-center justify-center gap-1 ${
                  product.stock_status === "sold_out"
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full overflow-hidden border border-stone-200 max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 overflow-y-auto space-y-6 flex-1">
              ...
              <div className="flex justify-between items-center border-t border-stone-100 pt-6">
                ...
                <a
                  href={selectedProduct.stock_status === "sold_out" ? undefined : getProductWhatsAppLink(selectedProduct)}
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`px-8 py-3 rounded-full font-bold text-sm transition-all flex items-center justify-center gap-2 ${
